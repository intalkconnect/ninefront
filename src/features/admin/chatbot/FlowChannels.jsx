    ...
    case "whatsapp":
      return (
        <svg viewBox="0 0 32 32" style={s} aria-label="WhatsApp">
          <path
            fill="#25D366"
            d="M16.04 3C9.39 3 4 8.38 4 15.02c0 2.53.75 4.88 2.05 6.84L4 29l7.34-2.02c1.88 1.16 4.1 1.84 6.49 1.84 6.65 0 12.04-5.38 12.04-12.02C29.86 8.38 22.69 3 16.04 3z"
          />
          <path
            fill="#FFF"
            d="M12.72 10.75c-.27-.6-.55-.61-.81-.62-.21-.01-.46-.01-.71-.01s-.65.09-1 .46c-.34.37-1.3 1.27-1.3 3.1 0 1.82 1.33 3.58 1.51 3.83.19.25 2.56 4.03 6.25 5.49 3.09 1.22 3.72.98 4.39.92.67-.06 2.17-.88 2.48-1.73.31-.85.31-1.58.22-1.73-.09-.15-.34-.25-.71-.44-.37-.19-2.17-1.07-2.5-1.19-.34-.12-.58-.19-.83.19-.25.37-.96 1.19-1.18 1.44-.22.25-.44.28-.81.09-.37-.19-1.53-.56-2.92-1.78-1.08-.96-1.81-2.15-2.03-2.52-.22-.37-.02-.58.17-.77.18-.18.41-.47.62-.72.2-.25.27-.43.41-.71.12-.28.06-.52-.03-.71-.09-.18-.78-1.95-1.08-2.62z"
          />
        </svg>
      );
    case "facebook":
      return (
        <svg viewBox="0 0 24 24" style={s} aria-label="Facebook">
          <path
            fill="#1877F2"
            d="M24 12.073C24 5.405 18.627 0 12 0 5.373 0 0 5.405 0 12.073 0 18.09 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.356c0-3.007 1.792-4.666 4.533-4.666 1.313 0 2.686.235 2.686.235v2.953h-1.514c-1.492 0-1.955.93-1.955 1.885v2.256h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.09 24 12.073z"
          />
        </svg>
      );
    case "instagram":
      return (
        <svg viewBox="0 0 24 24" style={s} aria-label="Instagram">
          ...
          <path
            fill="url(#ig)"
            d="M12 2.2c3.2 0 3.6 0 4.9.1 1.2.1 1.9.2 2.4.4.6.2 1 .5 1.5 1 .5.5.8.9 1 1.5.2.5.3 1.2.4 2.4.1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c-.1 1.2-.2 1.9-.4 2.4-.2.6-.5 1-1 1.5-.5.5-.9.8-1.5 1-.5.2-1.2.3-2.4.4-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.2-.1-1.9-.2-2.4-.4-.6-.2-1-.5-1.5-1-.5-.5-.8-.9-1-1.5-.2-.5-.3-1.2-.4-2.4C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.9c.1-1.2.2-1.9.4-2.4.2-.6.5-1 1-1.5.5-.5.9-.8 1.5-1 .5-.2 1.2-.3 2.4-.4C8.4 2.2 8.8 2.2 12 2.2z"
          />
    ...
    case "telegram":
      return (
        <svg viewBox="0 0 240 240" style={s} aria-label="Telegram">
          ...
          <path
            fill="#fff"
            d="M52 120l118-46c5.6-2.2 10.5 1.3 8.7 9.3l-20.1 94.8c-1.4 6.4-5.3 8-10.7 5L113 154l-17.9 17.3c-2 2-3.6 3.6-7.3 3.6l2.6-37.1 67.7-61.1c3-2.6-.6-4.1-4.6-1.5l-83.8 53.2-36.1-11.4c-7.8-2.4-7.9-7.8 1.5-11.1z"
          />
        </svg>
      );
    default:
...
export default function FlowChannels() {
  ...
  // status informativo do tenant (fonte de contas), NÃO decide “conectado”
  ...
  // vínculos reais do FLOW (única fonte de verdade para “conectado”)
  ...
  async function loadAll() {
    ...
    try {
      ...
      // tenant status (apenas para preencher dados do cartão)
      try {
  ...
  // cria/atualiza o vínculo *deste* flow
  ...
  const openWaProfile = () =>
    navigate("/settings/channels/whatsapp/profile", {
      state: { returnTo: `/development/flowhub/${flowId}/channels` },
    });
            ...
            <div style={S.actions}>
              {isBound("whatsapp") ? (
                ...
                <button
                  style={S.btnPrimary}
                  onClick={() =>
                    connectThisFlow("whatsapp", wa.id, wa.display || "WhatsApp")
                  }
                >
                  Conectar WhatsApp
                </button>
                ...
                <button
                  ...
                  onClick={() =>
                    connectThisFlow(
                      "instagram",
                      ig.igUserId,
                      ig.igUsername || ig.pageName || "Instagram"
                    )
                  }
                >
                  Conectar Instagram
