// src/features/admin/chatbot/components/helpers/nodeHelpers.js
...
/* ================= Normalizadores (seguros para preview) ================= */
export function normalizeInteractive(content) {
...
export function normalizeMedia(content) {
...
/* ================= Constantes de limite + helper visual ================= */
export const LIMITS = {
  body: 1024,
  footer: 60,
  headerText: 60,
