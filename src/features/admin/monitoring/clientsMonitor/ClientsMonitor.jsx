...
export default function ClientsMonitor() {
  ...
  return (
    <div className={styles.page}>
      {/* Header no padrão do FlowHub */}
      <header className={styles.header}>
        <div className={styles.titleBlock}>
          <h1 className={styles.title}>Monitor em tempo real</h1>
          <p className={styles.subtitle}>
            Operação em tempo real: quem espera, quem respondeu e quem precisa
            de ajuda.
          </p>
        </div>
      ...
      <section className={styles.tableCard}>
        <div className={styles.tableHeader}>
          <h2 className={styles.tableTitle}>
            ...
            <span className={styles.kpill}>{totalItems}</span>
          </h2>
        </div>
